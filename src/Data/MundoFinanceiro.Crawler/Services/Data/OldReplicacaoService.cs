...
{
    [MappedService]
    internal class OldReplicacaoService : IOldReplicacaoService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILogger<OldReplicacaoService> _logger;
        private readonly IMapper _mapper;

        public OldReplicacaoService(IUnitOfWork unitOfWork, ILogger<OldReplicacaoService> logger, IMapper mapper)
        {
