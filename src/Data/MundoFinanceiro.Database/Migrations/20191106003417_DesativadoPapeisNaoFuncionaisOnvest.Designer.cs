...
namespace MundoFinanceiro.Database.Migrations
{
    ...
    [Migration("20191106003417_DesativadoPapeisNaoFuncionaisOnvest")]
    partial class DesativadoPapeisNaoFuncionaisOnvest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MundoFinanceiro.Database.Contracts.Persistence.Domains.Replicacao", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_replicacoes");

                    b.HasIndex("Url")
                        .IsUnique()
                        .HasName("ix_replicacoes_url");

                    b.ToTable("replicacoes");
                });
