    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(conf =>
            {
                ...
                {
                    Title = $"MundoFinanceiro.Api ({VersionConstants.V1})",
                    Version = VersionConstants.V1,
                    Description = "API utilizada para realizar a requisição dos dados dos papéis.",
        ...
        private void ConfigureContainer(IServiceCollection services)
        {
            ...
            // ApiSettings (Environment Variables)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint($"/swagger/{VersionConstants.V1}/swagger.json", $"MundoFinanceiro.Api ({VersionConstants.V1})"));
        }
    }
}